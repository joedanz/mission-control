// ABOUTME: POST to close a PR. Requires Pull requests: Write on GITHUB_TOKEN.

import { requireAllowedUser, UnauthorizedError } from '@/lib/authz';
import { getProjectBySlug } from '@/lib/queries';
import { parseGitHubRepo } from '@/lib/github';
import { closePull, GitHubApiError } from '@/lib/github-api';
...
export async function POST(
  ...
  try {
    await closePull(githubRepo, prNumber);
